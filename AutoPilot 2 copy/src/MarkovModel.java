...
public class MarkovModel{
	...
	private HashMap<String, KGram> kgrams = new HashMap<String, KGram>();
	private HashMap<String, ResponseSeed> inputOutputTree = new HashMap<String, ResponseSeed>();
	...
	private class ResponseSeed {
		...
		public int averageLength() {
			...
			return total / responses.keySet().size();
		}
	...
	private class KGram {
		...
		private java.util.HashMap<Character, Integer> charCounts 
	...
	public MarkovModel() {
    	In reader = new In("test-data/stopwords.txt");
    	while(reader.hasNextLine()) {
    		...
    		stopwords[stopwordIndex++] = reader.readLine();
    	}
	}
